...
import { List, ListSubheader, ListItemButton, ListItemIcon, ListItemText, ListItemButtonProps } from "@mui/material";

interface KListItemButtonProps extends ListItemButtonProps{

}

const KListItemButton : React.FC<KListItemButtonProps> = ( {children, ...props} )=>{
