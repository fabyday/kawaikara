...
export const load_update_status_f = () => {
    return ipcRenderer.invoke(KAWAI_API_LITERAL.update.status);
};

export const start_update_download_f = () => {
    return ipcRenderer.invoke(KAWAI_API_LITERAL.update.start_download);
};

export const cancel_update_f = () => {
    return ipcRenderer.invoke(KAWAI_API_LITERAL.update.cancel);
};

export const install_update_f = () => {
    return ipcRenderer.invoke(KAWAI_API_LITERAL.update.install);
};

export const close_update_f = () => {
    ipcRenderer.send(KAWAI_API_LITERAL.update.close);
};

export const notify_update_status_f = (callback: (...args: any[]) => void) => {
    ipcRenderer.on(
