...
// import { KawaiPreference } from '../../main/definitions/setting_types';
import {
    priority,
    ModifierKeyMap,
    ReverseModifierKeyMap,
    convertKawaiKeyCode,
} from '../../main/definitions/keyboard';
import { normalize_action_string } from '../../main/definitions/action';
type props = {
    id: string;
...
const ignore_set = new Set<string>(['lalt+tab', 'lalt+f4']);
/**
 *
 * @param param0
 * @returns
...
function ShortcutTextField({
    ...
    const textFieldRef = useRef<HTMLInputElement>(null); // TextField???´ë? input???€??ref
