...
openssl genpkey -algorithm RSA -out ./private/private-key-mac.pem 
...
openssl pkcs12 -export -in ./private/my-cert.crt -inkey ./private/private-key-mac.pem -out ./private/my-cert.p12 -nodes
