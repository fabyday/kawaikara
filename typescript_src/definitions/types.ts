...
export type KawaiRecursiveTypeExtractor<Type, RemainderType> = {
    [ 
      ...
      // what if object( nested item like component or compounded item.)
        // as IsCompound<RemoveOptionalArgs<Type[Property]>> extends true 
        as IsCompound<ExtractCompound<Type[Property]>> extends true 
          ? Property 
          : Property extends keyof RemainderType 
            ? Property 
            : never  
    ] 
    : IsCompound< ExtractCompound<Type[Property]> > extends true ? 
    KawaiRecursiveTypeExtractor<ExtractCompound<Type[Property]>, RemainderType> | ExtractLeaf<Type[Property]> 
    : Type[Property] 
