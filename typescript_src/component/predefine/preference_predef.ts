...
let apply_changed_preference_f = (configure : Configure)=>{ipcRenderer.invoke("apply-changed-preference", configure)}
let save_and_close_f = (configure : Configure)=>{apply_changed_preference_f(configure); ipcRenderer.invoke("close")}
